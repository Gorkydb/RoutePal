// ProfileSetupScreen.js (UI ve step tanımları tam, hatasız sürüm - API'siz)
...
const countryList = ['Türkiye', 'Almanya', 'Fransa'];
const cityData = {
...
export default function ProfileSetupScreen({ navigation }) {
  ...
  const handleSelect = (key, value) => {
    if (key === 'country') setCityList(cityData[value] || []);
  ...
  const renderInputGroup = () => {
    const handleConfirm = (date) => {
      ...
      setFormData(prev => ({ ...prev, birthDate: formatted, age }));
...
const styles = StyleSheet.create({
  ...
  optionButton: {
    padding: 12, backgroundColor: '#ffffff70', borderRadius: 10, marginBottom: 8
  },
  photoBox: {
    width: 140, height: 140, borderRadius: 70, borderWidth: 2, borderColor: '#ccc', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', marginVertical: 20
  },
  photoImage: {
